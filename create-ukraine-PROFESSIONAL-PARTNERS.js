#!/usr/bin/env node
/**
 * Together for Ukraine - PROFESSIONAL PARTNER SHOWCASE
 * Uses elegant logo card design that looks professional
 * Inspired by world-class partnership pages
 */
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* BACK COVER - PROFESSIONAL PARTNER SHOWCASE */
        .back-cover {
            background: ${COLORS.nordshore};
            color: ${COLORS.white};
            padding: 60px 80px;
        ...
        .google-logo { color: #4285F4; font-family: Arial, sans-serif; }
        .aws-logo { color: #FF9900; font-weight: 800; }
        .babbel-logo { color: #FF5A5F; }
        .oxford-logo { color: #002147; font-size: 13pt; text-align: center; line-height: 1.3; }
        .bain-logo { color: #c00; }
...
<!-- PAGE 4: BACK COVER - PROFESSIONAL PARTNER SHOWCASE -->
    ...
    <div class="partner-section">
        <div class="partner-grid">
            <div class="partner-logo-card">
                <div class="partner-logo-text google-logo">Google</div>
            </div>
            ...
            <div class="partner-logo-card">
                <div class="partner-logo-text babbel-logo">Babbel</div>
            </div>
            ...
            <div class="partner-logo-card">
                <div class="partner-logo-text oxford-logo">Oxford<br>University<br>Press</div>
            </div>

            <div class="partner-logo-card">
                <div class="partner-logo-text aws-logo">AWS</div>
            </div>

            <div class="partner-logo-card">
                <div class="partner-logo-text">Cornell</div>
            </div>
            ...
            <div class="partner-logo-card">
                <div class="partner-logo-text bain-logo">Bain & Co</div>
            </div>
        </div>
    </div>
...
async function createProfessionalPartnersPDF() {
    console.log('\n' + '='.repeat(80));
    console.log('TOGETHER FOR UKRAINE - PROFESSIONAL PARTNER SHOWCASE');
    console.log('Features:');
    console.log('  • White logo cards with brand colors');
    console.log('  • Professional grid layout');
    console.log('  • Brand-appropriate typography and colors');
    ...
    console.log('[2/4] Rendering HTML...');
    await page.setContent(html);
    await page.waitForTimeout(1000);

    const outputPathHTML = path.join(__dirname, 'exports', 'Together-for-Ukraine-PROFESSIONAL.html');
    const outputPathPDF = path.join(__dirname, 'exports', 'Together-for-Ukraine-PROFESSIONAL.pdf');
    ...
    console.log('\n' + '='.repeat(80));
    console.log('PROFESSIONAL PDF CREATED');
    console.log('='.repeat(80));
    console.log(`\nPDF: ${outputPathPDF}`);
    console.log(`HTML: ${outputPathHTML}`);
    console.log(`Size: ${fileSizeKB} KB`);
    console.log('\nProfessional Features:');
    console.log('  ✓ White logo cards with clean design');
    console.log('  ✓ Brand-specific colors (Google blue, AWS orange, etc.)');
    console.log('  ✓ Professional grid layout');
    console.log('  ✓ Clean shadows and spacing');
    console.log('\nOpening in browser...\n');

    require('child_process').exec(`start "" "http://localhost:8080/exports/Together-for-Ukraine-PROFESSIONAL.html"`);
}

createProfessionalPartnersPDF().catch(console.error);
