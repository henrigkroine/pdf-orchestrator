#!/usr/bin/env node
/**
 * Together for Ukraine - SYSTEM FONTS VERSION
 * Uses system-installed fonts instead of base64 embedding
 * FIXES: Text duplication/corruption from base64 font embedding
 */
...
<head>
    ...
    <style>
        ...
        * {
        ...
        body {
            /* Use system-installed fonts - already installed via install-fonts.ps1 */
...
<div class="page content-page">
    ...
    <div class="sidebar-section" style="min-height: 280px;">
    ...
    <div class="sidebar-section" style="min-height: 180px;">
        <div class="gold-sidebar"></div>
        <div class="sidebar-content">
    ...
    <div class="section-header" style="font-size: 22pt; margin-top: 40px;">Key Elements</div>
    <div class="body-text" style="font-size: 11pt;">
...
<div class="page back-cover">
    ...
    <div class="logo-container" style="margin-bottom: 0;">
        <div class="logo-box">
            <div class="logo-together" style="font-size: 26pt;">Together for</div>
        </div>
        <div class="logo-ukraine" style="font-size: 30pt;">UKRAINE</div>
    </div>
...
async function createSystemFontsPDF() {
    console.log('\n' + '='.repeat(80));
    console.log('TOGETHER FOR UKRAINE - SYSTEM FONTS VERSION');
    console.log('Fixes:');
    console.log('  • Uses system-installed Lora + Roboto fonts');
    console.log('  • NO base64 embedding (prevents text corruption)');
    console.log('  • Georgia fallback for safety');
    ...
    console.log('[2/4] Rendering HTML with system fonts...');
    await page.setContent(html);

    // Wait for layout to stabilize
    await page.waitForTimeout(1000);

    const outputPathHTML = path.join(__dirname, 'exports', 'ukraine-SYSTEM-FONTS.html');
    const outputPathPDF = path.join(__dirname, 'exports', 'ukraine-SYSTEM-FONTS.pdf');
    ...
    console.log('\nFont Approach:');
    console.log('  ✓ System-installed fonts (Lora + Roboto)');
    console.log('  ✓ Georgia fallback for compatibility');
    console.log('  ✓ NO base64 embedding (prevents corruption)');
    console.log('\nNext Step: Run QA validation');
    console.log('  node scripts/validate-pdf-quality.js exports/ukraine-SYSTEM-FONTS.html\n');
}

createSystemFontsPDF().catch(console.error);
