...
async function main() {
  ...
  if (args.length < 2) {
    ...
    console.log('Usage:');
    console.log('  node scripts/compare-pdf-visual.js <test-pdf> <reference-name>\n');
    console.log('Example:');
    console.log('  node scripts/compare-pdf-visual.js exports/ukraine-new.pdf ukraine-final\n');
