...
Template uses Adobe Document Generation merge fields.
"""
...
# Content section with dynamic loop
content_section = doc.add_paragraph()
run = content_section.add_run('{{#content}}')
run.font.name = 'Arial'
run.font.size = Pt(11)

# Content item
item = doc.add_paragraph()
run = item.add_run('{{content}}')
run.font.name = 'Arial'
run.font.size = Pt(11)
