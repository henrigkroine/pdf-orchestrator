#!/usr/bin/env node
/**
 * Together for Ukraine - WORKING SIMPLE VERSION
 * Based on ukraine-final.pdf that WORKS (no text corruption)
 * Simplified approach that avoids Playwright PDF rendering bugs
 */
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* PAGE 1: COVER - SIMPLIFIED (NO COMPLEX CSS) */
        .cover {
...
<div class="page content-page">
    ...
    <div class="body-text" style="margin-top: 20px; font-size: 9.5pt;">
...
<div class="page back-cover">
    <div class="logo-container">
        <div class="logo-box" style="padding: 16px 24px;">
            <div class="logo-together" style="font-size: 24pt;">Together for</div>
        </div>
        <br>
        <div class="logo-ukraine" style="font-size: 28pt; padding: 10px 24px;">UKRAINE</div>
    </div>
...
async function createWorkingPDF() {
    console.log('\n' + '='.repeat(80));
    console.log('TOGETHER FOR UKRAINE - WORKING SIMPLE VERSION');
    console.log('Based on ukraine-final.pdf structure (NO text corruption)');
    console.log('Avoids complex CSS that breaks Playwright PDF rendering');
    ...
    const outputPathHTML = path.join(__dirname, 'exports', 'ukraine-WORKING.html');
    const outputPathPDF = path.join(__dirname, 'exports', 'ukraine-WORKING.pdf');
    ...
    console.log('\n' + '='.repeat(80));
    console.log('PDF CREATED - TESTING FOR TEXT CORRUPTION');
    console.log('='.repeat(80));
    console.log(`\nPDF: ${outputPathPDF}`);
    console.log(`HTML: ${outputPathHTML}`);
    console.log(`Size: ${fileSizeKB} KB`);
    console.log('\nApproach:');
    console.log('  ✓ Simplified CSS (no complex gradients)');
    console.log('  ✓ No decorative circles with opacity');
    console.log('  ✓ Based on working ukraine-final.pdf structure');
    console.log('  ✓ Georgia serif font (safe fallback)');
