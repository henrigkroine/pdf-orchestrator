...
class WorldClassPDFCreator:
    ...
    def validate_pdf(self, pdf_path: str) -> Dict[str, Any]:
        ...
        if self.skip_validation:
            self.log('Validation skipped (--skip-validation flag)', 'warning')
    ...
    def create(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not validation.get('passed') and not validation.get('skipped'):
                print('⚠️  Validation issues detected. Review validation report in exports/validation-issues/\n')
